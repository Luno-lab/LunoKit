...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I6oojue2nhp42f>, false, never>;
        /**
    ...
    Balances: {
         ...
         */
        Holds: StorageDescriptor<[Key: SS58String], Anonymize<Ifosl32ihgoeq6>, false, never>;
        /**
    ...
    Proxy: {
         ...
         */
        Proxies: StorageDescriptor<[Key: SS58String], Anonymize<I3khkuiss7sr1m>, false, never>;
        /**
...
type IRuntimeCalls = {
    ...
    DryRunApi: {
         ...
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: DotXcmVersionedLocation, xcm: DotXcmVersionedXcm], Anonymize<Ib748gt0noucrc>>;
    };
    /**
