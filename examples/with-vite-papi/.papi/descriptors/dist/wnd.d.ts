...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I7l46q2pu39ff3>, false, never>;
        /**
    ...
    VoterList: {
         ...
         */
        Lock: StorageDescriptor<[], undefined, true, never>;
    };
    NominationPools: {
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<I899s3bea07uhp>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<Ien4lr4fudcv6n>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I899s3bea07uhp>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<If4vg1nqgsug9f>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I899s3bea07uhp>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I8jelntdlnkiac>>;
        /**
         ...
         *  or both.
         */
        if_else: TxDescriptor<Anonymize<I744ski63ogn94>>;
        /**
         *Dispatches a function call with a provided origin.
         *
         ...
         *The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<If4vg1nqgsug9f>>;
    };
    Identity: {
        /**
    ...
    Recovery: {
         ...
         */
        as_recovered: TxDescriptor<Anonymize<I56lg8bnrufikk>>;
        /**
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<I4b0ab4u33u43u>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<I1ac18p6pjahv9>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<I80ht5q6a46692>>;
        /**
         *Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<I8lqgni993i7d9>>;
        /**
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<If1sr4hm0el5a0>>;
        /**
         *Authenticates the sudo key and dispatches a function call with `Root` origin.
         *This function does not check the weight of the call, and instead allows the
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<I8jelntdlnkiac>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<I5n05n33uogjb5>>;
        /**
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<Ifbgj6kc27nn2q>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I9ogfrmgl88pdb>>;
        /**
    ...
    Multisig: {
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I23foj0lhdkppt>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Ic45kejcb5v86h>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<If1sr4hm0el5a0>>;
    };
    Treasury: {
        /**
    ...
    MetaTx: {
         ...
         */
        dispatch: TxDescriptor<Anonymize<I2jj01cl2iqks8>>;
    };
    Beefy: {
        /**
         *Report voter equivocation/misbehavior. This method will verify the
...
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<Iab150pc00u513>>;
        /**
         *`:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<I9ol0kobt15obh>>;
    };
    Indices: {
        /**
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I513i4g3u308ia>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I529op3ifr7ped>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I6ak1c6bp7djtf>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<Ietea96bmm1cg2>>;
    };
    Identity: {
        /**
    ...
    Scheduler: {
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<I5jmupb1kai3jj>>;
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<Idl66os3793p2c>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<Idl66os3793p2c>>;
    };
    Proxy: {
        /**
         *A proxy was executed correctly, with the given.
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I6ak1c6bp7djtf>>;
        /**
    ...
    Multisig: {
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I965kkmkm4dqqk>>;
        /**
    ...
    FastUnstake: {
         ...
         */
        Unstaked: PlainDescriptor<Anonymize<If1bar61j9m2mv>>;
        /**
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<I9q52ail4t02bm>>;
    };
    Treasury: {
        /**
    ...
    Crowdloan: {
         ...
         */
        HandleBidResult: PlainDescriptor<Anonymize<I524tcsd6dpr31>>;
        /**
    ...
    MetaTx: {
         ...
         *information.
         */
        Dispatched: PlainDescriptor<Anonymize<Ibpfoajp33bp2j>>;
    };
    IdentityMigrator: {
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I34cq3ne0l8i73>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I1ut1enje04g2m>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I1ut1enje04g2m>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I16qqgglq4ega1>, call: Anonymize<I1ut1enje04g2m>, result_xcms_version: number], Anonymize<Ie7s8tm59rggr4>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I6e426h0457po1>>;
    };
    /**
...
export type WndDispatchError = Anonymize<Icrp2r0j3sbgko>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
