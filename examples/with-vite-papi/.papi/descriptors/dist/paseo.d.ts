...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Ia5993kjv8a1tl>, false, never>;
        /**
    ...
    Proxy: {
         ...
         */
        Proxies: StorageDescriptor<[Key: SS58String], Anonymize<I6piac7omi5lpd>, false, never>;
        /**
...
type ICalls = {
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<I3p13kido05bum>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<Idi2o3quauop42>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<Ie0v9n6or5lh9r>>;
        /**
         *Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<I1eosriit8hpo3>>;
        /**
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<I3dq5m6mb8ta46>>;
    };
    Parameters: {
        /**
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<I4qgdq1nsq1ldf>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<Id6nml1be4ntg1>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I4qgdq1nsq1ldf>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<Id4coi5m2c4fbi>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I4qgdq1nsq1ldf>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<Ic81m9070nb7fh>>;
    };
    Proxy: {
        /**
         ...
         */
        proxy: TxDescriptor<Anonymize<Idpsmkk8cmveiu>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I8nstg9vo0fosk>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Icg17asei4oejt>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I4sp01qlh6rkhp>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<I3dq5m6mb8ta46>>;
        /**
         *Authenticates the sudo key and dispatches a function call with `Root` origin.
         *This function does not check the weight of the call, and instead allows the
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<Ic81m9070nb7fh>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<Id3ingc7s7iq1i>>;
        /**
...
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I9d21uli0ks815>>;
        /**
         *`:code` was updated.
         */
    ...
    Scheduler: {
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<Ifr47nm7thgrp4>>;
        /**
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<Iag65bq4k2ea97>>;
    };
    Parameters: {
        /**
         *A Parameter was set.
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I8h7evu8bnn18n>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<Iev8df16vlcnrm>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I1hl4th07hmok3>>;
    };
    Proxy: {
        /**
         *A proxy was executed correctly, with the given.
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I1hl4th07hmok3>>;
        /**
    ...
    Multisig: {
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I6aucqi8p470ta>>;
        /**
    ...
    FastUnstake: {
         ...
         */
        Unstaked: PlainDescriptor<Anonymize<I9tpbs57uqggl>>;
        /**
    ...
    Crowdloan: {
         ...
         */
        HandleBidResult: PlainDescriptor<Anonymize<I648p81puvbjcl>>;
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<Idja5vsh7mfgto>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<Idja5vsh7mfgto>>;
    };
};
type IError = {
    System: {
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<Ikgci99ap0ffp>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Ibqu3kf8ifskue>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Ibqu3kf8ifskue>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: PolkadotRuntimeOriginCaller, call: Anonymize<Ibqu3kf8ifskue>], Anonymize<I399nsqbaqlr2u>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: DotXcmVersionedLocation, xcm: DotXcmVersionedXcm], Anonymize<Ib0m46eqe594fl>>;
    };
    /**
...
export type PaseoDispatchError = Anonymize<I50ikjune0gg0u>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type PaseoCallData = Anonymize<Ibqu3kf8ifskue> & {
    value: {
        type: string;
    };
};
