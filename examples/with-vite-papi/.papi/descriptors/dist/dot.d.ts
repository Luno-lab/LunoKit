...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Icv0uola4fi0sv>, false, never>;
        /**
...
type ICalls = {
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<I4ip6ol0gghhtt>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<Ic1m22rlm0tu62>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<Idhjnad4uvg4fu>>;
        /**
         *Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<I1e44oto040r12>>;
        /**
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<I77087oirkh329>>;
    };
    Parameters: {
        /**
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<I2d0r9q7g2cm99>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<I3fek2uacie2dd>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I2d0r9q7g2cm99>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<If87292opriu11>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I2d0r9q7g2cm99>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I5mundj2cf4hhs>>;
    };
    Proxy: {
        /**
         ...
         */
        proxy: TxDescriptor<Anonymize<Ia5fuanmi4lveu>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<Iab8tq4jvqftue>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I9tdu4rgc5k1b>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I6q5208tn6ph2e>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
...
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I6ovmp09cui4ob>>;
        /**
         *`:code` was updated.
         */
    ...
    Scheduler: {
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<I4pem65k15fchj>>;
        /**
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<Iabbkuinvp2njd>>;
    };
    Parameters: {
        /**
         *A Parameter was set.
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I1a5gf4n0nqs72>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I4t689jva3ns0s>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<Ierrtqmdqhej88>>;
    };
    Proxy: {
        /**
         *A proxy was executed correctly, with the given.
         */
        ProxyExecuted: PlainDescriptor<Anonymize<Ierrtqmdqhej88>>;
        /**
    ...
    Multisig: {
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<Idpl8oj4a549ub>>;
        /**
    ...
    FastUnstake: {
         ...
         */
        Unstaked: PlainDescriptor<Anonymize<I4nceha17l8sr8>>;
        /**
    ...
    Crowdloan: {
         ...
         */
        HandleBidResult: PlainDescriptor<Anonymize<Idbrt7si4i461v>>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I327rt3qgnu4r6>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I3om0s7br1hkf1>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I3om0s7br1hkf1>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: PolkadotRuntimeOriginCaller, call: Anonymize<I3om0s7br1hkf1>], Anonymize<Iethufiek9l1gc>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: DotXcmVersionedLocation, xcm: DotXcmVersionedXcm], Anonymize<I79o4oopf2n4rp>>;
    };
    /**
...
export type DotDispatchError = Anonymize<Icb996amjvq1c5>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type DotCallData = Anonymize<I3om0s7br1hkf1> & {
    value: {
        type: string;
    };
};
