...
const connectors = [
  Substrate.ledgerConnector({ chains }),
  Substrate.onekeyConnector(),
  Substrate.polkadotjsConnector(),
  Substrate.subwalletConnector(),
  Substrate.talismanConnector(),
  Substrate.polkagateConnector(),
  Substrate.fearlessConnector(),
  Substrate.mimirConnector(),
  Substrate.enkryptConnector(),
  Substrate.walletConnectConnector({ projectId: import.meta.env.VITE_WALLET_CONNECT_ID }),
  Substrate.novaConnector({ projectId: import.meta.env.VITE_WALLET_CONNECT_ID }),
];
