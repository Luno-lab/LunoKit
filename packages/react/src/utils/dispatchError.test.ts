...
describe('getReadableDispatchError', () => {
  ...
  describe('Module errors', () => {
    it('should return decoded error message when findErrorMeta succeeds', () => {
      ...
      expect(result).toBe(
        '[useSendTransaction]: Balances.InsufficientBalance error,  The account balance is too low.'
      );
    });
    ...
    it('should handle multiple docs entries', () => {
      ...
      expect(result).toBe(
        '[useSendTransaction]: Assets.NoPermission error,  The account does not have permission. Check your account privileges.'
      );
    });
    ...
    it('should handle findErrorMeta throwing an error', () => {
      ...
      expect(result).toBe(
        '[useSendTransaction]: Module Error (index: 5, error: 0x00000000) - Failed to decode: Failed to decode error metadata'
      );
    });
    ...
    it('should handle findErrorMeta throwing non-Error object', () => {
      ...
      expect(result).toBe(
        '[useSendTransaction]: Module Error (index: 10, error: 0x00000005) - Failed to decode: Unknown error'
      );
    });
  });
