...
import { kusamaChain, assethubKusamaChain, peopleKusamaChain, coretimeKusamaChain } from '../config/logos/generated'
...
export const kusamaAssetHub: Chain = {
  ...
  nativeCurrency: { name: 'Kusama Asset Hub', symbol: 'KSM', decimals: 12 },
  rpcUrls: { webSocket: ['wss://kusama-asset-hub-rpc.polkadot.io', 'wss://asset-hub-kusama-rpc.n.dwellir.com'] },
  ss58Format: 2,
...
export const kusamaPeople: Chain = {
  ...
  name: 'People Kusama',
  nativeCurrency: { name: 'Kusama People', symbol: 'KSM', decimals: 12 },
  rpcUrls: { webSocket: ['wss://kusama-people-rpc.polkadot.io', 'wss://people-kusama-rpc.n.dwellir.com'] },
  ss58Format: 2,
...
export const kusamaCoretime: Chain = {
  ...
  nativeCurrency: { name: 'Kusama Coretime', symbol: 'KSM', decimals: 12 },
  rpcUrls: { webSocket: ['wss://kusama-coretime-rpc.polkadot.io', 'wss://coretime-kusama-rpc.n.dwellir.com'] },
  ss58Format: 2,
