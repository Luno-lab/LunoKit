import { mimirSubstrateWallet } from '../../../config/logos/generated';
import type { SubstrateConnectOptions } from '../../../types';
import { InjectConnector, type InjectConnectorOptions } from '../base/inject';
...
export class MimirConnector extends InjectConnector {
  ...
  public async connect({ appName }: SubstrateConnectOptions) {
    if (!this.mimirReady) {
